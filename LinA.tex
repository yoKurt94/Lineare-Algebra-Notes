...
%In Tests oder Klausuren werden wir oft mit der Aufgabe konfrontiert, Basen zu finden. Hier zeigen wir exemplarisch, wie man das macht
%Es wird von uns am Ende des Semesters erwartet, dass wir so argumentieren können wie im folgenden Beispiel (Klausurrelevant!)
...
%Jetzt folgt der absolute Standard Ansatz: 
...
\begin{center}
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{Images/4.60.jpeg}
    \end{figure}
\end{center}
