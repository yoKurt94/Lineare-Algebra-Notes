...
\newpage
\date{Donnerstag, 11.01.24} \footnote{vgl. S. ? aus Baer.}
...
Dann wäre $X$ aber wegen der Bedingung b) fpr lineare Abhängigkeit linear abhängig, was ein Widerspruch zur Definition der Basis ist. \\
b) $\Rightarrow$ a): \\
