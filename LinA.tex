...
a) 
\begin{align*}
    \measuredangle (x,x) = \arccos \left( \frac{\langle x,y \rangle}{\|x\| \cdot \|x\|} \right) = \arccos \left( \frac{\|x\|^2}{\|x\| \cdot \|x\|} \right) = \arccos(1) = 0 \\
\end{align*}
b) 
\begin{align*}
...
\begin{align*}
    ...
    \end{pmatrix} \rangle \\
    &= (\cos \theta \cdot v_1 - \sin \theta \cdot v_2) \cdot (\cos \theta \cdot w_1 - \sin \theta \cdot w_2) + (\sin \theta \cdot v_1 + \cos \theta \cdot v_2) \cdot (\sin \theta \cdot w_1 + \cos \theta \cdot w_2) \\
